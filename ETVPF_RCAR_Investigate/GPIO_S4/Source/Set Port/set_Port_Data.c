 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Oct 19 11:49:46 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME set_Port_Data
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void set_Port_Data_Outputs_wrapper(const boolean_T *u0,
			boolean_T *y0,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    set_Port_Data_Outputs_wrapper(u0, y0, port, p_width0, pin, p_width1);
}
